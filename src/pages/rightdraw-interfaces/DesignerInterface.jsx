...
const DesignerInterface = () => {
  ...
  const fetchInitialData = useCallback(async () => {
    try {
      ...
      setFormData((prev) => {
        ...
        //       "is_sub_2_categories_exists": true
        //     },
        //     {
        //       "id": 16,
        //       "name": "2",
        ...
        // },{
        //   "category_id": 9,
        //   "category_name": "If Multilayer, Second Dielectric Thickness",
        //   "subcategories": [
        //     {
        //       "id": 15,
        //       "name": "0",
        ...
        // },{
        //   "category_id": 9,
        //   "category_name": "Category of Feed Thru Pin",
        //   "subcategories": [
        //     {
        //       "id": 15,
        //       "name": "Feed Thru Pin",
  ...
  const validators = {
    ...
    [STEPS.PCB_SPECS]: (data) => {
      ...
      return (
        Object.keys(data.selectedSpecs).length === data.specifications.length
      );
    },
    [STEPS.DESIGN_RULES]: (data) => {
      return (
        REQUIRED_FIELDS[STEPS.DESIGN_RULES].every(
          (field) => data[field]?.trim().length > 0
        ) &&
        data.acknowledge &&
        data.rules.length > 0
                ...
                .map(([optionId]) => {
                  ...
                  return (
                    <div key={optionId} className="bg-gray-50 rounded-xl p-6">
                      <h3 className="text-xl font-bold text-blue-600 mb-6 pb-2 border-b border-gray-200">
                        {option.desing_option_name}
                      </h3>
